        ...
        stage('Run project'){
            steps {
                withCredentials([string(credentialsId: params.TELEGRAM_TOKEN, variable: 'TOKEN')]) {
                    ...
                    sh label: '', script: 'BUILD_ID=dontKillMe sudo docker run -d -e TELEGRAM_TOKEN=$TOKEN --name lanitbusschedulebot-' + params.TELEGRAM_TOKEN + ' lanitbusschedulebot:' + params.TELEGRAM_TOKEN
